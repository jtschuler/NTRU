        ...
        while True:
            try:
                ...
                if True:
                    ...
                    flag = False
                    for _ in range(2):
                        message = [randint(-self.p//2,self.p//2) for _ in range(self.N)]
                        ...
                        if d != message:
                            ...
                            break
                    if flag: continue
                if(not polynomials.trim(polynomials.multiplication(self.Fp, self.f, self.p)) == [1]):
                    continue
                if(not polynomials.trim(polynomials.multiplication(self.Fq, self.f, self.q)) == [1]):
                    continue
                return
